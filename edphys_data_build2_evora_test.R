# edphys_data_build2_evora_test.r
...
ed_kendall_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-East_Florida.xlsx",sheetName="Kendall")
ed_JFK_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-East_Florida.xlsx",sheetName="JFK")
ed_JFKPBG_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-East_Florida.xlsx",sheetName="PBG FSED")
ed_JFKBB_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-East_Florida.xlsx",sheetName="BB FSED")

ed_hunters_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-North_Florida.xlsx",sheetName="Hunters Creek")
ed_ocala_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-North_Florida.xlsx",sheetName="Ocala")
ed_osceola_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-North_Florida.xlsx",sheetName="Osceola")
ed_summerfield_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-North_Florida.xlsx",sheetName="Summerfield FSED")
ed_wmarion_1117 <- read.xlsx("q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/ED_Physician_Report-1117-North_Florida.xlsx",sheetName="West Marion")
ed_data_nov_17 <- rbind(ed_kendall_1117,ed_JFK_1117,ed_JFKPBG_1117,ed_JFKBB_1117,ed_hunters_1117,ed_ocala_1117,ed_osceola_1117,ed_summerfield_1117,ed_wmarion_1117)
write.xlsx2(ed_data_nov_17, "q:/Anesthesia/_DropOff/ED_Reports/Site_Data_Capture/R/Consolidated/ed_data_nov_17.xlsx", sheetName="nov", col.names=TRUE, row.names=FALSE, append=FALSE)

ed_data_2017 <- rbind(ed_data_jan_17,ed_data_feb_17,ed_data_mar_17,ed_data_apr_17,ed_data_may_17,ed_data_jun_17,ed_data_jul_17,ed_data_aug_17,ed_data_sep_17,ed_data_oct_17,ed_data_nov_17)
